...
static const unsigned char* skipPrefix (const unsigned char* name, int *scope)
{
	...
	else if (length > 5 && strncasecmp ((const char*) name, "<SID>", (size_tee) 5) == 0)
	{
		if (scope != NULL)
			*scope = *name;
		result = name + 5;
...
static boolean isMap (const unsigned char* line)
{
	 ...
	 */
	if (
			strncmp ((const char*) line, "map",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "nm",       (size_tee) 2) == 0 ||
			strncmp ((const char*) line, "nma",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "nmap",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "vm",       (size_tee) 2) == 0 ||
			strncmp ((const char*) line, "vma",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "vmap",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "om",       (size_tee) 2) == 0 ||
			strncmp ((const char*) line, "oma",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "omap",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "im",       (size_tee) 2) == 0 ||
			strncmp ((const char*) line, "ima",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "imap",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "lm",       (size_tee) 2) == 0 ||
			strncmp ((const char*) line, "lma",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "lmap",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "cm",       (size_tee) 2) == 0 ||
			strncmp ((const char*) line, "cma",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "cmap",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "no",       (size_tee) 2) == 0 ||
			strncmp ((const char*) line, "nor",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "nore",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "norem",    (size_tee) 5) == 0 ||
			strncmp ((const char*) line, "norema",   (size_tee) 6) == 0 ||
			strncmp ((const char*) line, "noremap",  (size_tee) 7) == 0 ||
			strncmp ((const char*) line, "nno",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "nnor",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "nnore",    (size_tee) 5) == 0 ||
			strncmp ((const char*) line, "nnorem",   (size_tee) 6) == 0 ||
			strncmp ((const char*) line, "nnorema",  (size_tee) 7) == 0 ||
			strncmp ((const char*) line, "nnoremap", (size_tee) 8) == 0 ||
			strncmp ((const char*) line, "vno",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "vnor",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "vnore",    (size_tee) 5) == 0 ||
			strncmp ((const char*) line, "vnorem",   (size_tee) 6) == 0 ||
			strncmp ((const char*) line, "vnorema",  (size_tee) 7) == 0 ||
			strncmp ((const char*) line, "vnoremap", (size_tee) 8) == 0 ||
			strncmp ((const char*) line, "ono",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "onor",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "onore",    (size_tee) 5) == 0 ||
			strncmp ((const char*) line, "onorem",   (size_tee) 6) == 0 ||
			strncmp ((const char*) line, "onorema",  (size_tee) 7) == 0 ||
			strncmp ((const char*) line, "onoremap", (size_tee) 8) == 0 ||
			strncmp ((const char*) line, "ino",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "inor",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "inore",    (size_tee) 5) == 0 ||
			strncmp ((const char*) line, "inorem",   (size_tee) 6) == 0 ||
			strncmp ((const char*) line, "inorema",  (size_tee) 7) == 0 ||
			strncmp ((const char*) line, "inoremap", (size_tee) 8) == 0 ||
			strncmp ((const char*) line, "lno",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "lnor",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "lnore",    (size_tee) 5) == 0 ||
			strncmp ((const char*) line, "lnorem",   (size_tee) 6) == 0 ||
			strncmp ((const char*) line, "lnorema",  (size_tee) 7) == 0 ||
			strncmp ((const char*) line, "lnoremap", (size_tee) 8) == 0 ||
			strncmp ((const char*) line, "cno",      (size_tee) 3) == 0 ||
			strncmp ((const char*) line, "cnor",     (size_tee) 4) == 0 ||
			strncmp ((const char*) line, "cnore",    (size_tee) 5) == 0 ||
			strncmp ((const char*) line, "cnorem",   (size_tee) 6) == 0 ||
			strncmp ((const char*) line, "cnorema",  (size_tee) 7) == 0 ||
			strncmp ((const char*) line, "cnoremap", (size_tee) 8) == 0 
			)
			return TRUE;
...
static void parseFunction (const unsigned char *line)
{
	...
	while ((line = readVimLine ()) != NULL)
	{
		 ...
		 */
		if ( (!strncmp ((const char*) line, "endfo", (size_tee) 5) == 0) && 
				(strncmp ((const char*) line, "endf", (size_tee) 4) == 0)   )
			break;
...
static void parseAutogroup (const unsigned char *line)
{
	...
	if (isspace ((int) *cp))
	{
		...
		if (*cp)
		{
			if (strncasecmp ((const char*) cp, "end", (size_tee) 3) != 0)
			{	 
				do
				{
					vStringPut (name, (int) *cp);
...
static boolean parseCommand (const unsigned char *line)
{
	...
	else if ( (!strncmp ((const char*) line, "comp", (size_tee) 4) == 0) && 
		     (!strncmp ((const char*) line, "comc", (size_tee) 4) == 0) && 
				(strncmp ((const char*) line, "com", (size_tee) 3) == 0) )
	{
		cp += 2;
...
static boolean parseMap (const unsigned char *line)
{
	...
	do
	{
		...
		if (strncmp ((const char*) cp, "<Leader>", (size_tee) 8) == 0)
			break;
	
		if (
				strncmp ((const char*) cp, "<buffer>", (size_tee) 8) == 0 ||
				strncmp ((const char*) cp, "<silent>", (size_tee) 8) == 0 ||
				strncmp ((const char*) cp, "<script>", (size_tee) 8) == 0 ||
				strncmp ((const char*) cp, "<unique>", (size_tee) 8) == 0
		   )
		{
			cp += 8;
			continue;
		...
		if (strncmp ((const char*) cp, "<expr>", (size_tee) 6) == 0)
		{
			cp += 6;
			continue;
		}
	
		if (strncmp ((const char*) cp, "<special>", (size_tee) 9) == 0)
		{
			cp += 9;
			continue;
		}
...
static boolean parseVimLine (const unsigned char *line)
{
	...
	if ( (!strncmp ((const char*) line, "comp", (size_tee) 4) == 0) && 
			(!strncmp ((const char*) line, "comc", (size_tee) 4) == 0) && 
			(strncmp ((const char*) line, "com", (size_tee) 3) == 0) )
	{
	...
	if (strncmp ((const char*) line, "fu", (size_tee) 2) == 0)
	{
		parseFunction(line);
	}

	if	(strncmp ((const char*) line, "aug", (size_tee) 3) == 0)
	{
		parseAutogroup(line);
	}

	if ( strncmp ((const char*) line, "let", (size_tee) 3) == 0 )
	{
		parseLet(line);
	}
