...
*   MACROS
*/
#define xMalloc(n,Type)    (Type *)eMalloc((size_tee)(n) * sizeof (Type))
#define xCalloc(n,Type)    (Type *)eCalloc((size_tee)(n), sizeof (Type))
...
extern void *malloc (size_tee);
extern void *realloc (void *ptr, size_tee);
#endif
extern void *eMalloc (const size_tee size);
extern void *eCalloc (const size_tee count, const size_tee size);
extern void *eRealloc (void *const ptr, const size_tee size);
extern void eFree (void *const ptr);

/* String manipulation functions */
extern int struppercmp (const char *s1, const char *s2);
extern int strnuppercmp (const char *s1, const char *s2, size_tee n);
#ifndef HAVE_STRSTR
