...
# include <stdlib.h>  /* to define size_tee */
#endif
...
/*	size_tee  length; */ /* size of buffer used */
	size_tee  size;    /* allocated size of buffer */
...
extern void vStringNCatS (vString *const string, const char *const s, const size_tee length);
...
extern void vStringNCopyS (vString *const string, const char *const s, const size_tee length);
